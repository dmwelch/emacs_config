...
(defun mjs/setup-local-eslint ()
    "If ESLint found in node_modules directory - use that for flycheck. Intended for use in PROJECTILE-AFTER-SWITCH-PROJECT-HOOK."
    (interactive)
...
;;   (interactive)
;;   (cond ((eq major-mode 'web-mode) (js2-mode))
;;         ((eq major-mode 'js2-mode) (web-mode) (web-mode-set-content-type "jsx"))
